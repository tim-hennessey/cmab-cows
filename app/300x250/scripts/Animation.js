...
app.Animation = (function () {
	...
	function initialize() {
		...
		t.set("#bg", {scale:1.3, transformOrigin: "100% 0%"});
	...
	function start() {
		t.delayedCall(0.0, step1);
		t.delayedCall(1.0, step2);
	}
